...
DEFINE_LEVEL("OBAKE YASHIKI",   LEVEL_BBH,              COURSE_BBH,      bbh,              spooky,   28000,    0x00, 0x00, 0x00, _,         _)
DEFINE_LEVEL("YUKIYAMA", LEVEL_CCM,              COURSE_CCM,      ccm,              slide,    17000,    0x00, 0x00, 0x00, _,         _)
DEFINE_LEVEL("SELECT ROOM",    LEVEL_CASTLE,           COURSE_NONE,     castle_inside,    inside,   20000,    0x00, 0x00, 0x00, _,         sCamCastle)
STUB_LEVEL(  "CAVE MAZE", LEVEL_HMC,              COURSE_HMC,                                  16000,    0x00, 0x00, 0x00, _,         _)
STUB_LEVEL(  "SABAKU PRMIDO", LEVEL_SSL,              COURSE_SSL,                                  15000,    0x00, 0x00, 0x00, _,         _)
STUB_LEVEL(  "BATTLE FIELD",   LEVEL_BOB,              COURSE_BOB,                                  15000,    0x00, 0x00, 0x00, _,         _)
STUB_LEVEL(  "YUKIDARUMA",      LEVEL_SL,               COURSE_SL,                                   14000,    0x00, 0x00, 0x00, _,         _)
STUB_LEVEL(  "MIZUMI NO MACHI",       LEVEL_WDW,              COURSE_WDW,                                  17000,    0x00, 0x00, 0x00, _,         _)
DEFINE_LEVEL("CHINBOTSUSEN", LEVEL_JRB,              COURSE_JRB,      jrb,              water,    20000,    0x00, 0x00, 0x00, _,         _)
...
STUB_LEVEL(  "FIRE BUBBLE2", LEVEL_RR,               COURSE_RR,                                   20000,    0x00, 0x00, 0x00, _,         _)
...
STUB_LEVEL(  "HORI MINI", LEVEL_VCUTM,            COURSE_VCUTM,                                30000,    0x00, 0x00, 0x00, _,         _)
STUB_LEVEL(  "TIKA LAVA", LEVEL_BITFS,            COURSE_BITFS,                                16000,    0x00, 0x00, 0x00, _,         _)
STUB_LEVEL(  "SUISOU",    LEVEL_SA,               COURSE_SA,                                   20000,    0x00, 0x00, 0x00, _,         _)
STUB_LEVEL(  "HEAVEN",    LEVEL_BITS,             COURSE_BITS,                                 16000,    0x00, 0x00, 0x00, _,         _)
DEFINE_LEVEL("VOLCANO", LEVEL_LLL,              COURSE_LLL,      lll,              generic,  22000,    0x00, 0x00, 0x00, _,         _)
DEFINE_LEVEL("SUBMARINE",     LEVEL_DDD,              COURSE_DDD,      ddd,              water,    17000,    0x00, 0x00, 0x00, sDynDDD,   _)
DEFINE_LEVEL("CASTLE2",       LEVEL_WF,               COURSE_WF,       wf,               generic,  13000,    0x00, 0x00, 0x00, _,         _)
...
STUB_LEVEL(  "MINI SLID", LEVEL_PSS,              COURSE_PSS,                                  20000,    0x00, 0x00, 0x00, _,         _)
STUB_LEVEL(  "IN THE FALL",    LEVEL_COTMC,            COURSE_COTMC,                                18000,    0x00, 0x00, 0x00, _,         _)
STUB_LEVEL(  "MARIO FLY", LEVEL_TOTWC,            COURSE_TOTWC,                                20000,    0x00, 0x00, 0x00, _,         _)
DEFINE_LEVEL("KUPPA1",         LEVEL_BOWSER_1,         COURSE_BITDW,    bowser_1,         generic,  VAL_DIFF, 0x00, 0x00, 0x00, _,         _)
STUB_LEVEL(  "RAINBOW CLOUDS",  LEVEL_WMOTR,            COURSE_WMOTR,                                20000,    0x00, 0x00, 0x00, _,         _)
...
STUB_LEVEL(  "MONKEY MOUNTAIN", LEVEL_TTM,              COURSE_TTM,                                  15000,    0x00, 0x00, 0x00, _,         _)
